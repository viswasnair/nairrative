...
FICTION: ${fictionCount} (${Math.round(fictionCount/books.length*100)}%) | NON-FICTION: ${books.length-fictionCount}`;
  ...
  const SEED_ANALYSIS = {"geographic":"Your library reveals a reader rooted in the American-British thriller-and-SF axis who has been on a slow, deliberate journey toward literary decolonization. The early foundation (1998–2010) is overwhelmingly Anglo-American — a near-complete consumption of Sidney Sheldon (18 books), Michael Crichton (16), Frederick Forsyth, Robert Ludlum, John Grisham, Robin Cook, Arthur Hailey — the canonical airport-thriller authors of the US and UK, supplemented by the Anglo-American SF canon (Clarke, Asimov, Herbert, Gibson, Stephenson). With 197 books from the US and 74 from the UK, these two countries account for roughly 74% of your entire reading life. But the Indian strand (48 books) tells a far more interesting story of evolving engagement with your own literary geography. The early Indian entries are populist and diasporic — Khushwant Singh's *The Company of Women*, Anurag Mathur's comedic *The Inscrutable Americans* — alongside Gandhi's autobiography and Kamala Das's memoir, which you notably reread in 2012. Then comes the Amish Tripathi phase (Shiva Trilogy, Ram Chandra Series), a distinctly Indian commercial fantasy phenomenon with no Western equivalent, before a striking pivot around 2019–2021 toward serious Indian literary and political engagement: Arundhati Roy (both novels), Rohinton Mistry's *A Fine Balance*, Vikram Seth's monumental *A Suitable Boy*, Perumal Murugan's Tamil Dalit narratives (*One Part Woman*, *Poonachi*), Mohsin Hamid's *The Reluctant Fundamentalist*, Jerry Pinto's *Em and the Big Hoom*, and Unni R.'s translated Malayalam fiction. Simultaneously, your non-fiction turned to Indian political critique — Rana Ayyub's *Gujarat Files*, Shashi Tharoor's *An Era of Darkness*, Ambedkar's *Annihilation of Caste*, and Josy Joseph's *A Feast of Vultures*. The rest of the world remains strikingly thin: Brazil appears only through Paulo Coelho's philosophical fables, Russia through Dostoevsky and Nabokov (both read in English translation), Germany through Hesse and Hitler, Sweden through Larsson alone, and Israel through Harari's non-fiction trilogy. Entire literary continents — Africa, East Asia, the Middle East, Latin America beyond Coelho and Márquez — are virtually absent, with the notable exception of Osamu Tezuka's *Buddha* and Elif Shafak's two Turkish novels read in 2020. The most recent entries (2025–2026) show no geographic expansion whatsoever, retreating entirely into American/British romantasy (Sarah J. Maas, Rebecca Yarros, Sanderson) with the sole exception of Banu Mushtaq's Kannada-translated *Heart Lamp* — suggesting that your geographic diversification was a concentrated 2019–2021 phenomenon, possibly driven by a period of national introspection, rather than a permanent broadening of your reading world.","thematic":"This library traces a remarkable arc from the worship of individual exceptionalism toward an increasingly systemic understanding of power, society, and interconnection. The early reading foundation is strikingly built on lone-genius narratives — Ayn Rand's Howard Roark and John Galt, Michael Crichton's maverick scientists, Sidney Sheldon's ruthlessly ambitious protagonists, Frederick Forsyth's singular operatives like the Jackal — all embodying the fantasy that extraordinary individuals bend the world to their will. Even the nonfiction mirrors this: Feynman's irreverent brilliance, Che Guevara's romantic individualism, the biographies of Steve Jobs and Elon Musk. But a quiet philosophical counter-thread has always been present — Siddhartha, The Alchemist, The Power of Now, and later the Upanishads and Goenka's Buddhist teachings — suggesting an early tension between ego-driven achievement and ego-dissolution. The pivotal shift comes around 2019-2021, where the reading transforms dramatically: suddenly the focus is on systems and structures rather than individuals. Guns, Germs, and Steel (read earlier) was perhaps a seed, but now Sapiens, Homo Deus, Caste by Isabel Wilkerson, Ambedkar's Annihilation of Caste, Shashi Tharoor's An Era of Darkness, Kahneman's Thinking Fast and Slow, Naomi Klein's This Changes Everything, and Donella Meadows' Thinking in Systems collectively represent a reader grappling with how institutions, biases, economies, and climate systems shape human fate far more than any lone hero. The Indian political cluster — Rana Ayyub's Gujarat Files, Swati Chaturvedi's I Am a Troll, Josy Joseph's A Feast of Vultures — reveals someone specifically interrogating the machinery of power in their own national context. Meanwhile, the fiction evolution is equally telling: the Sanderson obsession (18 books) isn't merely about fantasy escapism but represents a fascination with meticulously constructed magical *systems* — hard magic with rules, costs, and internal logic — which is the fictional analogue of the nonfiction turn toward systems thinking. The recent and striking emergence of romantasy through Sarah J. Maas's ACOTAR series and Rebecca Yarros's Empyrean books in 2025-2026 marks yet another thematic evolution: after decades dominated by male protagonists in thrillers and hard SF, the reader has gravitated toward female-centered narratives where emotional vulnerability, desire, and romantic connection are treated as forms of power rather than weakness — a remarkable departure from the Sheldon/Forsyth/Ludlum paradigm that once dominated. Rohinton Mistry's A Fine Balance, Perumal Murugan's One Part Woman and Poonachi, Jerry Pinto's Em and the Big Hoom, and Agota Kristof's Claus Trilogy form a quiet but devastating strand of literature about ordinary people crushed by forces beyond their control — the precise inversion of the Rand/Sheldon worldview. This reader's journey is ultimately one from 'the world bends to the will of the exceptional' toward 'the world is a complex system in which connection, structure, and vulnerability matter more than individual brilliance.'","complexity":"This reader's intellectual trajectory reveals a fascinating arc from consumable plot-driven machinery toward genuinely demanding literary and philosophical architecture. The early reading (1998–2010) is dominated by authors who are essentially narrative engineers — Sidney Sheldon's 18 books are pure momentum prose, Michael Crichton's 16 titles dress techno-anxiety in thriller clothing, and the Ludlum/Forsyth/Grisham axis represents espionage and legal procedurals with minimal structural ambition. Yet even within that period, there are unmistakable signals of reaching: Kundera's *The Unbearable Lightness of Being*, Nabokov's *Lolita* (2011), and the complete Ayn Rand corpus suggest someone drawn to novels that embed philosophical arguments within narrative. The real complexity inflection begins around 2012–2013 with Brandon Sanderson's intricate magic-system worldbuilding (Mistborn, Stormlight Archive) and Scott Lynch's con-artist layering in *The Lies of Locke Lamora*, but the most striking leap comes in 2019–2021, where the reader tackles Vikram Seth's 1,349-page *A Suitable Boy*, Dostoevsky's *Crime and Punishment*, Rushdie's *Midnight's Children*, and Agota Kristof's devastating *Claus Trilogy* — works demanding sustained attention to unreliable narration, postcolonial allegory, and fractured identity. Simultaneously, non-fiction complexity surges: Kahneman's *Thinking, Fast and Slow*, Nick Lane's *The Vital Question* (genuinely difficult bioenergetics), and Ambedkar's *Annihilation of Caste* mark a shift from Bryson/Freakonomics-level popularization toward primary-source-adjacent argumentation. Peter Watts's *Blindsight*, read early, stands out as an anomalous spike — a novel whose consciousness-questioning difficulty far exceeds anything else from that era, suggesting it may have been a formative encounter. The 2025–2026 pivot to romantasy (Yarros's Empyrean trilogy, Maas's ACOTAR series) represents a deliberate complexity regression, prioritizing emotional immersion over structural or intellectual challenge, which mirrors a pattern also visible in the 2015 dip toward James Patterson's *Maximum Ride*. Notably, the reader repeatedly engages complete series but abandoned Tolkien after *Fellowship* and never returned — perhaps the one instance where high-fantasy density proved less appealing than Sanderson's more systematized, almost engineering-minded approach to worldbuilding, revealing that this reader's complexity appetite favors rule-based intricacy over mythopoeic density.","emotional":"There is a remarkable emotional arc buried in this library that traces a journey from controlled detachment toward increasing vulnerability. The early reading life is dominated by architects of plot machinery — Sidney Sheldon, Michael Crichton, Frederick Forsyth, Robert Ludlum — authors whose characters are chess pieces moved through ingenious scenarios, where the reader's engagement is intellectual suspense rather than empathic connection. Even the literary fiction from that period tends toward the philosophically distanced: Ayn Rand's individualist manifestos (reread every 7-10 years, suggesting they function as emotional anchors or identity touchstones), Kundera's cerebral meditation on lightness, Hesse's allegorical *Siddhartha*. The Hannibal Lecter series is telling — Thomas Harris writes about the architecture of psychopathy, making empathy itself an object of clinical study rather than something felt. But something shifts gradually. By 2019, books like Rohinton Mistry's *A Fine Balance* and Jerry Pinto's *Em and the Big Hoom* — both devastating portrayals of suffering, poverty, and mental illness in India — signal a willingness to sit with unmediated pain. Paul Kalanithi's *When Breath Becomes Air* that same year marks a direct confrontation with mortality stripped of genre armor. The 2020 memoir explosion — Obama, Michelle Obama, Trevor Noah, Malala, Agassi — suggests a hunger for real human interiority, while Elif Shafak's two novels and *A Gentleman in Moscow* embrace emotional warmth without cynicism. The 2021 cluster is perhaps the most emotionally complex year: Dostoevsky's *Crime and Punishment*, Agota Kristof's devastating Claus Trilogy, Khushwant Singh's *Train to Pakistan*, Perumal Murugan's *Poonachi*, and Ambedkar's *Annihilation of Caste* together form a chorus of voices examining guilt, partition trauma, caste violence, and institutional cruelty — none of which the earlier thriller-dominated reading self would have gravitated toward. Then comes the most surprising turn: by 2025-2026, Sarah J. Maas's ACOTAR series and Rebecca Yarros's Empyrean trilogy — romantasy built entirely around emotional vulnerability, desire, and romantic intimacy — appear in the library of someone who once read almost exclusively about male protagonists navigating geopolitical conspiracies. This isn't a dilution of taste; it's an expansion of emotional bandwidth. The reader who once processed feeling through Rand's philosophy of rational self-interest now openly consumes stories structured around longing, emotional bonding, and the transformative power of romantic love, suggesting a profound softening — or perhaps a belated permission — to engage with tenderness as a legitimate literary and personal need.","discovery":"The most striking evolution in this library is the dramatic arc from hyper-masculine, plot-driven genre fiction toward increasingly emotionally complex and female-authored narratives. The pre-2010 and early reading is dominated almost entirely by male authors writing procedural thrillers and hard science fiction — Sidney Sheldon's 18 novels, Michael Crichton's 16, Frederick Forsyth's 9, Robert Ludlum's 5, John Grisham's 5, Robin Cook's 5 — forming a massive bedrock of airport-thriller consumption that reads like a systematic cataloguing of the genre's entire canon. This then transitions through Brandon Sanderson's 18 books (spanning 2011–2026), which function as a bridge: still plot-architecture-driven but introducing emotional interiority and worldbuilding patience. The truly non-obvious pattern is the 2025–2026 pivot into romantasy — Sarah J. Maas's full ACOTAR series (5 books) and Rebecca Yarros's Empyrean trilogy — which represents a genre the reader would almost certainly never have touched during the Sheldon/Forsyth/Ludlum era. This isn't random: the groundwork was laid by Jacqueline Carey's *Kushiel's Dart* in 2014, Madeline Miller's *Circe* in 2020, and Elif Shafak's novels in 2020, each incrementally introducing romance and feminine interiority into the fantasy-adjacent reading. Equally revealing is the 2021 non-fiction explosion — Harari's entire trilogy, Kahneman, Ambedkar, Naomi Klein, Banerjee — which shows a reader who once consumed ideology through Ayn Rand's complete works and *Mein Kampf* pivoting toward empirically-grounded social science and progressive political economy, suggesting the Indian political books of 2019 (Rana Ayyub's *Gujarat Files*, Swati Chaturvedi's *I Am a Troll*) were a catalytic turning point. The reader's completionist instinct is also notable: almost every author is consumed in bulk rather than sampled — all four Rama novels, all four Hannibal Lecter books, all four Kingsbridge novels, the full Foundation original trilogy, every Inheritance Cycle entry — yet Tolkien's Lord of the Rings remains conspicuously unfinished after *The Fellowship of the Ring*, one of the very few abandoned series in a library defined by series completion, perhaps suggesting the reader's taste runs more toward propulsive plotting than lyrical world-description.","temporal":"This reading journey reveals a fascinating three-act metamorphosis. The pre-2010 foundational period is dominated by a voracious appetite for male-authored, plot-driven commercial fiction — the complete works of Sidney Sheldon (18 books), Michael Crichton (16), Frederick Forsyth, Robert Ludlum's Bourne series, John Grisham's legal thrillers, and Robin Cook's medical thrillers — alongside canonical science fiction (Clarke's Rama and Odyssey cycles, Asimov's Foundation trilogy, Herbert's Dune). This era reads like a young reader systematically devouring entire author backlists, a completionist impulse that also consumed all five Ayn Rand novels. The 2011–2016 period marks a pivot toward epic fantasy as the new completionist obsession: Paolini's Inheritance Cycle, Sanderson's Mistborn Era 1, the beginning of Stormlight Archive and Wheel of Time, and the entire Harry Potter series read across 2011–2016 rather than during the original publication wave, suggesting a deliberate late discovery. Simultaneously, non-fiction begins creeping in — Isaacson's Steve Jobs, Will Durant's Story of Philosophy, the Upanishads — signaling an emerging intellectual curiosity beyond pure entertainment. The most dramatic transformation occurs in 2019–2021, where the reader pivots sharply toward Indian literary fiction (Rohinton Mistry's A Fine Balance, Arundhati Roy, Perumal Murugan, Mohsin Hamid, Salman Rushdie's Midnight's Children), Indian political non-fiction (Rana Ayyub's Gujarat Files, Shashi Tharoor's An Era of Darkness, Ambedkar's Annihilation of Caste), economics (Kahneman, Banerjee, Hazlitt), and environmental writing (Rachel Carson, Naomi Klein, Bill Gates). The 2021 peak of 40 books is the most intellectually diverse single year, uniquely blending Dostoevsky's Crime and Punishment with Agota Kristof's Claus Trilogy, Marcus Aurelius's Meditations, and Ken Follett's Century Trilogy — a reader no longer consuming genre backlists but curating across traditions. Then the 2025–2026 entries reveal a startling final pivot into romantasy — Sarah J. Maas's entire ACOTAR series and Rebecca Yarros's Empyrean trilogy — a genre completely absent from the prior 350 books, suggesting either a significant shift in personal taste or the influence of a new reading community. Brandon Sanderson is the only author who threads through every era (2011–2026), serving as the single constant across fifteen years of otherwise radical reinvention, his Cosmere functioning as a literary anchor while everything else transforms around it.","genre":"This library's genre evolution traces a profound intellectual journey from commercial genre machinery toward literary fiction, political non-fiction, and finally a surprising romantasy turn. The pre-2010 foundation is almost entirely thriller-dominated — Sidney Sheldon's 18 melodramatic potboilers (making him the single most-read author in the database), Michael Crichton's 16 techno-thrillers, the complete Forsyth espionage catalog, Ludlum's Bourne series, Grisham's legal procedurals, Robin Cook's medical thrillers, and Hailey's industry novels — a remarkably coherent genre ecosystem united by institutional drama and propulsive plotting. Science fiction runs parallel: Clarke's Rama and Odyssey quartets, Asimov's Foundation trilogy, Herbert's Dune, Gibson's Neuromancer, and Stephenson's Snow Crash form a canonical 1950–1990s SF curriculum consumed in apparent bulk. Fantasy was virtually absent until 2011, when Brandon Sanderson's Mistborn arrived and catalyzed an 18-book Cosmere obsession that became the single most sustained genre commitment of the reader's life, eventually matching Sheldon's count. The genre migration through the 2010s is visible in real time: Robert Jordan's Wheel of Time (Books 1–4), Patrick Rothfuss's Kingkiller Chronicle, Paolini's Inheritance Cycle, Ken Follett's Kingsbridge series — each representing a pivot from the quick-consumption thriller model toward multi-volume, years-long investment. Literary fiction arrives seriously only around 2016–2019, initially through South Asian diaspora voices (Adiga's White Tiger, Hamid's Reluctant Fundamentalist) before deepening into Rohinton Mistry, Perumal Murugan, Vikram Seth, and Rushdie. Non-fiction undergoes the most dramatic genre evolution: what began with accessible popular science (Dawkins, Feynman, Michio Kaku) and Ayn Rand's philosophical novels transformed by 2021 into rigorous engagement with economics (Kahneman, Banerjee, Hazlitt, Thaler), Indian political analysis (Rana Ayyub, Josy Joseph, Shashi Tharoor, Ambedkar), environmental policy (Carson, Klein, Gates), and systems thinking (Meadows). The 2025–2026 pivot to romantasy — five Sarah J. Maas ACOTAR books and three Rebecca Yarros Empyrean novels — is the single most genre-disruptive event in the database, introducing romance as a primary narrative engine for the first time across 350 books. Fantasy has been the dominant fiction genre for fifteen years, but this is Fantasy transformed: where Sanderson's appeal was systematic magic and plot architecture, Maas and Yarros center emotional intimacy and desire as plot drivers, representing a genuinely new register.","author":"This library reveals a reader whose authorial loyalties trace a fascinating arc from completist consumption of mass-market thriller machines to deep investment in architecturally ambitious worldbuilders. The early reading life (1998–2010) is dominated by a voracious, almost compulsive need to exhaust an author's catalog once discovered: all 18 Sidney Sheldon novels, all 16 available Michael Crichton works (including both posthumous releases), the complete Bourne series spanning both Robert Ludlum and Eric Van Lustbader, every Frederick Forsyth title available, five John Grisham legal thrillers, five Robin Cook medical thrillers, and all four Thomas Harris Hannibal Lecter novels. These authors share a specific DNA — plot-driven, high-concept, short-chaptered prose designed for propulsive reading — and the pattern suggests someone who, once hooked by a single title, refused to stop until the shelf was empty. The pivotal shift comes around 2011–2012 with the discovery of Brandon Sanderson, who ultimately matches Sheldon's count at 18 books but represents a radically different kind of completism: where Sheldon offered self-contained potboilers, Sanderson demands investment in an interconnected Cosmere spanning Mistborn Era 1 and 2, all four Stormlight Archive entries, standalones like Elantris and Warbreaker, and novellas — a commitment stretching from 2011 through 2026. The 2026 explosion into Sarah J. Maas (five ACOTAR books) and Rebecca Yarros (three Empyrean novels) marks yet another evolution — the embrace of romantasy, a striking departure for a reader whose formative authors were almost exclusively male. Notably, across the entire pre-2019 reading life, female authors are vanishingly rare (Ayn Rand, Jackie Collins, Jacqueline Carey, Agatha Christie, J.K. Rowling), making the recent Maas-Yarros binge not just a genre shift but a genuine reorientation of reading identity. Walter Isaacson appears three times (Steve Jobs, Einstein, Leonardo da Vinci) as the sole non-fiction author read with series-like dedication.","contextual":"This reading life tells a story of intellectual metamorphosis across three distinct acts. The pre-2011 period reveals a voracious young reader consuming genre fiction in completist fashion — devouring all 18 Sidney Sheldons, all 16 Michael Crichtons, all 9 Frederick Forsyths, the complete Bourne and Grisham catalogs — alongside a foundational science fiction education (Clarke's Rama and Space Odyssey quartets, Asimov's Foundation trilogy, Gibson's Neuromancer, Herbert's Dune) and formative philosophical encounters with Ayn Rand (whose Fountainhead and Atlas Shrugged are noted for rereading every 7-10 years, suggesting they were identity-shaping texts). The middle period (2011–2021) charts a remarkable pivot: Brandon Sanderson gradually replaces Sidney Sheldon as the dominant author, signaling a shift from plot-driven page-turners to intricate worldbuilding systems — mirrored by the concurrent embrace of Robert Jordan's Wheel of Time and Patrick Rothfuss's Kingkiller Chronicle. More strikingly, 2019–2021 witnesses an explosion of non-fiction engagement with Indian politics (Rana Ayyub's Gujarat Files, Swati Chaturvedi's I Am a Troll, Shashi Tharoor's An Era of Darkness, Ambedkar's Annihilation of Caste), economics (Banerjee, Kahneman, Hazlitt), and climate literature (Carson, Klein, Gates) — a reader who once consumed the world through American thriller lenses now interrogating power structures through Indian and global systemic frameworks. The 2020 memoir binge (Obama x2, Michelle Obama, Malala, Trevor Noah, Agassi) suggests someone seeking models of lived conviction. Perhaps most revealing is the 2025–2026 arc: the sudden emergence of Romantasy through Sarah J. Maas's complete ACOTAR series and Rebecca Yarros's Empyrean trilogy represents a dramatic genre departure for a reader whose history skewed heavily masculine in authorship and sensibility — alongside Banu Mushtaq's JCB Prize-winning Heart Lamp, this latest phase suggests a broadening of emotional register. The reader's Indian identity threads quietly throughout — from Kamala Das's memoir to Perumal Murugan, Jerry Pinto, R.K. Narayan, and Amish Tripathi — but these selections grow more politically conscious over time, evolving from Khushwant Singh's entertainment to Manu Pillai's revisionist histories and Josy Joseph's investigative journalism."};
