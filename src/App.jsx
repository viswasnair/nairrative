...
FICTION: ${fictionCount} (${Math.round(fictionCount/books.length*100)}%) | NON-FICTION: ${books.length-fictionCount}`;
  ...
  const SEED_RECS = {"more-like":[{"title":"Piranesi","author":"Susanna Clarke","year":2020,"reason":"Like Yumi, it drops you into an inventive dreamlike world where the protagonist discovers truth through artful observation — mysterious, layered, and quietly emotional."}],"more-by-last":[{"title":"Tress of the Emerald Sea","author":"Brandon Sanderson","year":2023,"reason":"A fairy-tale Cosmere novella with the same sense of wonder as Yumi — lighter in tone, cleverly narrated, and deeply satisfying for a Sanderson completionist."}],"similar-author":[{"title":"Promise of Blood","author":"Brian McClellan","year":2013,"reason":"McClellan studied under Sanderson and delivers the same detailed magic systems and political intrigue, with a gunpowder-fantasy twist that feels immediately fresh."}],"trending":[{"title":"James","author":"Percival Everett","year":2024,"reason":"The 2024 Pulitzer winner reimagines Huckleberry Finn from Jim's perspective — sharp, layered, and one of the most discussed literary novels in recent years."}],"challenge":[{"title":"2666","author":"Roberto Bolaño","year":2004,"reason":"A five-part masterwork spanning continents and decades — demanding but transformative, and one of the most ambitious novels of the past twenty years."}],"quick":[{"title":"The Vegetarian","author":"Han Kang","year":2007,"reason":"At 188 pages it is one of the most unsettling and beautifully constructed novels in contemporary literary fiction — a quick read that stays with you for months."}],"gaps":[{"title":"The Memory Police","author":"Yoko Ogawa","year":1994,"reason":"A quiet Japanese masterpiece about memory, loss, and disappearance — Ogawa's prose is deceptively spare and the novel's dread accumulates without you noticing."}],"surprise":[{"title":"Lincoln in the Bardo","author":"George Saunders","year":2017,"reason":"A Booker Prize-winning novel told entirely through ghosts and historical fragments — nothing in your library resembles it, and you will likely love it."}],"finish":[{"title":"Wind and Truth","author":"Brandon Sanderson","year":2024,"reason":"The conclusion to the first arc of The Stormlight Archive — the payoff to years of investment in Kaladin, Dalinar, and Szeth's intertwining journeys."}]};
