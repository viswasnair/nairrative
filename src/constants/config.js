...
export const DEFAULT_PANEL_PROMPTS = {
  ...
  thematic:   "Surface the 2-3 most significant recurring themes or intellectual preoccupations across the library. Do not reference specific years. Keep it concise — 3-4 sentences.",
  ...
  complexity: "Describe the balance between stretching and comfort reading this library reveals. What does the ratio of demanding to accessible reads say about how this person engages with books? Do not reference specific years. Keep it concise — 3-4 sentences, mention at most one or two specific examples.",
  emotional:  "Describe the dominant emotional palette of this library as a whole. What tones, moods, and emotional registers does this reader consistently seek out or avoid? Treat the library as a single body of work, not a timeline. Do not reference specific years. Keep it concise — 3-4 sentences.",
  blindspots: "Identify what's conspicuously absent from this library given the reader's apparent interests and patterns. What genres, cultures, perspectives, or forms would a thoughtful observer expect to find but don't? What do the gaps reveal about the reader? Do not reference specific years. Keep it concise — 3-4 sentences.",
